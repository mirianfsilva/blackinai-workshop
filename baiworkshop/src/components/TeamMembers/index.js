...
const thirdList = [
    ...
    },
    {
        ...
        title: 'Mírian Silva', 
        subtitle: 'IBM',
        bio: 'Mirian (She/Her) is a Software Engineer at IBM Brazil. She is a producer and instructor at Coursera, where she teaches Guided Projects. She holds a B. Sc. in Computational Mathematics from Federal University of Minas Gerais, Brazil. Her research interests include broadly Artificial intelligence and Machine Learning, with a special focus on Optimization and Computational Biology. She is an advocate and promotes women in STEM, having founded Girls Support Girls, a stem support for women in Brazil. She is volunteering with Black in AI 2020.',
        icon_1: <FontAwesomeIcon icon={["fab", "linkedin"]}/>,
        //icon_2: <FontAwesomeIcon icon={["fab", "twitter"]}/>,
